	...
	$('#gform-jquery').submit(function(e){ // вешаем событие на отправку формы
		...
		$.ajax({ // инициализируем аякс
            url: "https://docs.google.com/forms/d/e/1FAIpQLScsT4D3rtUYYa9jvMTFOis6jgdUILYijZ5UkKPBQ7Dk6S_guQ/formResponse", // слать надо сюда, строку с буковками надо заменить на вашу, это атрибут action формы
            ...
            statusCode: { // после того как пришел ответ от сервера
                0: function (){ // это успешный случай
                	form.html('<h4>Спасибо!</h4><p>Заявка отправлена </p>'); // сунем в форму сообщение что все ок
                },
